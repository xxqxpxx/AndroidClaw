...
private class TestDeviceActionBridge : DeviceActionBridge {
    ...
    override suspend fun tapScreenButton(label: String) = Result.success("ok")
    ...
    override suspend fun clearNotificationsFromApp(packageName: String) = Result.success("ok")
